var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var TextScramble = function () {
    function TextScramble(el) {_classCallCheck(this, TextScramble);
        ...
        var to = newText[i] || '';
          ...
          var end = Math.floor(Math.random() * 40) + start;
...
'aime l\'univers des mangas.',
'pratique l\'aquaponey.',
'essaie d\'être très green.',
'adore les nains !',
'aime apprendre et créer.',
'tchat avec le Capitain Kirk.',
'impressionne Chuck Norris.',
'aime les licornes.',
'a pu sortir du temple.',
'ne trouve pas la poulette.',
'connait une mite en pull-over.',
'apprend le klingon.',
'prend la voie 9 <i>3/4</i>.'
];


var el = document.querySelector('.generated-text');
